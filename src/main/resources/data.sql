...
INSERT INTO `tindercompany`.`candidates` (`candidate_id`, `email`, `github`, `linkedin`, `motto`, `name`, `password`) VALUES (2, 'marisa', 'github', 'linkdin', 'Hello Pimpolho', 'Marisa', '123');

COMMIT;


-- -----------------------------------------------------
-- Data for table `tindercompany`.`companys`
-- -----------------------------------------------------
START TRANSACTION;
USE `tindercompany`;
INSERT INTO `tindercompany`.`companys` (`company_id`, `email`, `motto`, `name`, `password`) VALUES (DEFAULT, 'altran@altran.com', 'We\'re french', 'Altran', '123');
INSERT INTO `tindercompany`.`companys` (`company_id`, `email`, `motto`, `name`, `password`) VALUES (DEFAULT, 'logicalis', 'We\'re Fuition', 'Logicallis', '123');
INSERT INTO `tindercompany`.`companys` (`company_id`, `email`, `motto`, `name`, `password`) VALUES (DEFAULT, 'academia@codigo.com', 'We\'re Crazy', 'Academia', '123');
